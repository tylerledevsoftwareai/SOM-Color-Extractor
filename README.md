...
```bash
git clone https://github.com/your-username/som-palette-api.git
cd som-palette-api
...
4. Connect your repository. Render will automatically detect `render.yaml` and provision the web service.

### Option B: Docker Web Service
1. Create a **New Web Service** on Render.
2. Choose **Docker** as the Environment.
3. Set the build command to use `Dockerfile`.
